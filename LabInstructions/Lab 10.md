##Lab 10 - Simple API Gateway with Zuul
...
3.  Lab 10 has copies of the word server.  Start 5 separate copies of the lab-10-word-server, using the profiles "subject", "verb", "article", "adjective", and "noun".  There are several ways to do this, depending on your preference:
...
9.  Stop the lab-10-gateway application.
